...
<head>
    ...
    <link href="{{ asset('vendor/mazer/app.css') }}" rel="stylesheet">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div id="dropdown-menu-container" class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
