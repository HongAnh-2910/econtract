...
<ul class="list-unstyled mb-0 pb-4 list__file--parent">
    @if($folder->count() > 0)
        @foreach($folder as $parent)
            <li class="d-flex flex-md-column align-items-md-center flex-lg-row py-3 border-bottom content__upload--file--item2 content__upload--file--item active__private--folder">
                <input type="hidden"
                       class="folder__id"
