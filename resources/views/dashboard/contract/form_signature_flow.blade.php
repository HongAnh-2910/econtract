<div class="contract__box--face d-sm-flex pl-2 pr-2 flex-sm-wrap d-flex-none mb-4 pl-sm-1 pr-sm-0 pr-md-3 pl-md-3 px-lg-2 justify-content-between">
    <div class=" col-sm-6 pr-0 pl-0 pr-sm-1 pl-sm-1 pl-md-1 pr-md-2 col-lg-5 col-xl-4 pr-lg-1">
        <div class="form-group">
            ...
            <input type="text" autocomplete="off" name="business_name_follow[]" class="form-control p-2 rounded-0"
    ...
    <div class=" form-group mt-md-0 col-sm-6 pr-0 pl-0 pr-sm-1 pl-sm-1 pl-md-1 pr-md-2 pr-lg-1 col-lg-2 px-xl-2">
        <div class="input-group d-md-flex justify-content-center d-flex-none show__invalid--message">
            <div class="form-outline w-100">
                ...
                <input autocomplete="off" name="phone_contract_follow[]" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" minlength="10" maxlength="10" pattern="[0-9]+" type="text" class="phone__number--check form-control rounded-0 p-2"
                       placeholder=" " />
                <div class="invalid-feedback pl-0">
    ...
    <div class="mt-md-0 form-group col-sm-6 pr-0 pl-0 pr-sm-1 pl-sm-1 pl-md-2 pr-md-1 pl-lg-1 col-lg-2 col-xl-3 px-xl-2">
        <div class="input-group d-md-flex justify-content-center d-flex-none show__invalid--message">
            <div class="form-outline w-100">
                ...
                @enderror
                <input pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" autocomplete="off" name="email_contract_follow[]" type="email" class="form-control rounded-0 p-2 receivers__email--contracts"
                       placeholder="" />
                <div class="invalid-feedback pl-0">
