@extends('layouts.dashboard' ,['key' => 'dashboard_contract'])
@section('extra_cdn')
...
{{--                        <a class="px-4" href="{{ route('contract.add', ['type' => $type]) }}">--}}
...
{{--                        @php--}}
{{--                            $currentRoute = $type == \App\Helper\StatusConstants::TYPE_PERSONAL ? route('contract.index') : route('contract.index-company');--}}
{{--                        @endphp--}}
