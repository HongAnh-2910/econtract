<div class="modal fade" id="application__modal--importFile" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('web.applications.importExcel') }}" enctype="multipart/form-data">
                @csrf
