...
@section('content')
    ...
    <form method="POST" action="{{ route('web.applications.updateProposal', $application->id) }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-10 col-md-7">
                            <input name="proposal_name" class="form-control" type="text" placeholder="Tên đề xuất"
                                value="{{ $application->proposal_name }}" required>
                        </div>
                        ...
                        <div class="col-10 col-md-7 mt-3">
                            <div class="box__select--application">
                                <select name="reason" class="form-control select2 w-100" style="width: 100% !important;">
                                    <option @if ($application->reason == 'Bàn giao tài sản') selected @endif
                                        data-foo='Tên đề xuất "Tên thành viên - Phòng ban - BBBG + tên hàng/DV"'
                                        value="Bàn giao tài sản">Bàn giao tài sản</option>
                                    <option @if ($application->reason == 'Đề nghị mua hàng') selected @endif
                                        data-foo='Tên đề xuất "Tên thành viên - Phòng ban - Đề nghị mua + tên hàng"'
                                        value="Đề nghị mua hàng">Đề nghị mua hàng</option>
                                    <option @if ($application->reason == 'Đề nghị thanh toán') selected @endif
                                        data-foo='Tên đề xuất "Tên thành viên - Phòng ban - Đề nghị thanh toán + tên hàng/DV"'
                                        value="Đề nghị thanh toán">Đề nghị thanh toán</option>
                                    <option @if ($application->reason == 'Đề nghị tạm ứng') selected @endif
                                        data-foo='Tên đề xuất "Tên thành viên - Phòng ban - thanh toán tạm ứng + ngày tạm ứng"'
                                        value="Đề nghị tạm ứng">Đề nghị tạm ứng</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-10 col-md-3 mt-3">
                        ...
                        <div class="col-10 col-md-7 mt-3">
                            <input name="proponent" class="form-control" value="{{ $application->proponent }}"
                                type="text" placeholder="Người đề nghị" required>
                        </div>
                        <div class="col-10 col-md-3 mt-3">
                            <label class="mr-5 mb-2">Số tiền<span class="text-danger">*</span></label>
                        </div>
                        <div class="col-10 col-md-7 mt-3">
                            <input name="price_proposal" class="form-control" type="number" placeholder="Số tiền" value="{{ $application->price_proposal }}" required>
                        </div>
                        <script>
                            $(function() {
                                $(".select2").select2({
                        ...
                        <div class="col-12 col-md-7 mt-4">
                            <textarea style="width:418px; height:150px" class="form-control" required
                                ...
                                placeholder="Số tài khoản - Ngân hàng (chi nhánh) - Chủ tài khoản (nếu người nhận tiền khác người đề xuất)">{{ $application->account_information }}</textarea>
                        </div>
                                ...
                                <div class="col-10 col-xl-5">
                                    <select class="form-select" name="delivery_time" required>
                                        <option class="application__selectOption--disabled" value="" disabled="disabled"
                                            selected="selected">Chọn thời gian</option>
                                        <option @if ($application->delivery_time == 'Buổi sáng') selected @endif value="Buổi sáng">Buổi sáng</option>
                                        <option @if ($application->delivery_time == 'Buổi chiều') selected @endif value="Buổi chiều">Buổi chiều</option>
                                    </select>
                                </div>
                        ...
                        <div class="col-10 col-md-7 mt-4 application__file--customize">
                            <div class="application__file--inputFile">
                                ...
                                <input type="file" name="files" id="select_file" hidden>
                            </div>
                        </div>
