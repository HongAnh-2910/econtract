    ...
    <table style="width: 100%;">
        ...
        <tr style="display: flex; justify-content: center; width: 100%; margin-top: 15px;">
            <td
                style="
                    ...
                    line-height: 2rem;
                    color: #FFFFFF;">
                Các bên đã hoàn thành ký hợp đồng.
            </td>
        </tr>
        <tr style="display: flex; justify-content: center; width: 100%; margin-top: 80px;">
            <td style="border: 1px solid #C4C4C4; box-sizing: border-box; border-radius: 6px; padding: 8px 15px; margin: 0 auto">
                <a style="font-style: normal; text-decoration: none;font-weight: bold; font-size: 22px; line-height: 20px; display: flex; align-items: center; text-align: center; letter-spacing: 0.04em;color: #FFFFFF;" href="{{ $url }}">
                    TẢI XUỐNG HỢP ĐỒNG
                </a>
            </td>
        </tr>
